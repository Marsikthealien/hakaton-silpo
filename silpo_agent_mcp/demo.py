...
нагороди за прогрес, умови «Плюхс». Ховати це нечесно, а зашивати в код —
...
SETS: dict[str, dict] = {
    ...
    "rewards": {
        ...
        "why": ("Це концепт нагороди, а не купон: видавати знижки може лише "
                "«Сільпо». `silpo_get_promo_codes` уміє тільки читати — tool на "
                "видачу нагороди за прогрес і є те, чого бракує."),
